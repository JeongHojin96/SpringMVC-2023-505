...
<link rel="stylesheet"
	href="${rootPath}/static/css/board_detail.css?${version}">
<link rel="stylesheet"
	href="${rootPath}/static/css/board.css?${version}">
<script>
	...
	<div class="container">
		<div class="wrapper">
			...
			<div class="board_main">
				<div>
					<strong>카테고리 : </strong>${WRITE.b_ccode}</div>

				<div>
					<strong>제목 : </strong>${WRITE.b_title}</div>
				<div>
					<strong>작성자 : </strong>${WRITE.b_nickname}</div>
				<div>
			...
			<div class="button">
				<a href="${rootPath}/course">리스트로</a> <a
					href="${rootPath}/course/${WRITE.b_seq}/update">수정하기</a> <a
					href="${rootPath}/course/${WRITE.b_seq}/delete">삭제하기</a>
			</div>
		</div>
	</div>
</body>

	...
	<div class="container">
		<div class="wrapper">
			...
			<div class="list pagination">
				<ul>
					...
					<c:if test="${PAGINATION.firstPageNum != PAGINATION.pageNum }">
						...
						<li><a
							href="${rootPath}/review?page=${PAGINATION.pageNum -1}&search=${SEARCH}">&lt;</a></li>
					</c:if>
					...
					<c:if test="${PAGINATION.lastPageNum != PAGINATION.pageNum}">
						<li><a
							href="${rootPath}/review?page=${PAGINATION.pageNum +1}&search=${SEARCH}">&gt;</a></li>
						<li><a
							href="${rootPath}/review?page=${PAGINATION.finalPageNum}&search=${SEARCH}">마지막</a></li>
					</c:if>
					<c:if test="${PAGINATION.lastPageNum == PAGINATION.pageNum}">
						<li>&gt;</li>
						<li>마지막</li>
			...
			<div class="write button">
				<a href="${rootPath}/">홈으로</a> <a href="${rootPath}/review/write">게시글작성</a>
			</div>

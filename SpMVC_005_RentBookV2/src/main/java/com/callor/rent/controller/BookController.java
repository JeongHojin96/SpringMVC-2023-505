...
public class BookController {
	...
	public String update(@PathVariable("b_code") String bcode, @ModelAttribute("BOOK") BookDto bookDto, Model model) {
	...
	/*
	 * 만약 Req 를 하면서 num 변수에 값을 포함하여 보낼때 문자열, "", 아무것도 없는 값을 전달하면 서버는 400 오류가 난다 400
